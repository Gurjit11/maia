    ...
    <div>
      <div className="flex mt-5 gap-5">
        <div className="w-28 h-28">
          <img src={doctor?.doctorDetails?.profileImage} className="rounded-full" alt="doctor" />
        </div>
        ...
        <div className="flex-1 ">
          ...
          <div className="flex items-center gap-2">
            ...
            <p className="text-[#2B4360]">{doctor?.doctorDetails?.experiance} years</p>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <p className="text-[#2B4360] underline">{doctor?.reviewsStat?.totalReviews} reviews</p>
          </div>
        </div>
      </div>
        ...
        <div className="text-black sm:w-[70%] md:w-[50%] lg:w-[40%] xl:w-[30%] z-20 w-[100%] sm:flex-col rounded-3xl bg-white p-6">
          {completed ? (
            ...
            <>
              ...
              {step === 1 && (
                <Step1 doctor={doctor} onNext={() => setStep(step + 1)} setData={setData} />
              )}
              {step === 2 && (
                <Step2 doctor={doctor} onNext={() => setCompleted(true)} setData={setData} data={data} />
              )}
            </>
          )}
        </div>
