...
const DoctorPage = ({ params }) => {
  ...
  return (
    <div className="bg-gray-50 flex-col p-3 sm:p-20">
        ...
        <div className="flex-col justify-start items-start gap-4 flex">
          ...
          <div className="flex-col justify-start items-start gap-4 flex">
            ...
            <div className=" text-[#5f5f5f] text-xs font-normal font-['Poppins'] leading-none">
              ...
              approach to medicine. He took my fears seriously - primarily about
              the hormone injections - and worked with me to create a schedule
              that I was comfortable with, but that also got great results. He's
              one of the kindest and most knowledgeable doctors I've ever had.
            </div>
          </div>
        </div>
        <div className="flex-col justify-start items-start gap-4 flex">
