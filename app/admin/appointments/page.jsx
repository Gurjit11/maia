...
const AppointmentList = () => {
  ...
  const getAppointments = async () => {
    ...
    try {
      let data = JSON.stringify({
        appointmentId: "bbd5f104-96b5-49b3-8cb2-2caa43728fa5",
      });

      let config = {
        method: "post",
        maxBodyLength: Infinity,
        url: "https://maia.projectx38.cloud/dashboard-apis/maia-dashboard/appointments/details",
        headers: {
          "login-token":
            "",
          "Content-Type": "application/json",
